...
// IWYU pragma: private, include "GifPlaybackSubsystem.h"

#ifdef ANIMATEDGIF_GifPlaybackSubsystem_generated_h
#error "GifPlaybackSubsystem.generated.h already included, missing '#pragma once' in GifPlaybackSubsystem.h"
#endif
#define ANIMATEDGIF_GifPlaybackSubsystem_generated_h
...
private: \
	...
	friend ANIMATEDGIF_API UClass* Z_Construct_UClass_UGifPlaybackSubsystem_NoRegister(); \
public: \
	DECLARE_CLASS2(UGifPlaybackSubsystem, UTickableWorldSubsystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/AnimatedGif"), Z_Construct_UClass_UGifPlaybackSubsystem_NoRegister) \
...
#define FID_Users_Realf_OneDrive_Documents_DartsFolder_DartsInOrbit_Plugins_AnimatedGif_Source_AnimatedGif_Public_GifPlaybackSubsystem_h_23_ENHANCED_CONSTRUCTORS \
	...
	UGifPlaybackSubsystem(UGifPlaybackSubsystem&&) = delete; \
	UGifPlaybackSubsystem(const UGifPlaybackSubsystem&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UGifPlaybackSubsystem); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UGifPlaybackSubsystem); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(UGifPlaybackSubsystem) \
